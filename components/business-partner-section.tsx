...
export default function BusinessPartnerSection() {
  ...
  const industries = [
    {
      icon: <Building2 className="h-4 md:h-10 w-4 md:w-10 text-white" />,
      name: "Fintech",
    ...
    {
      icon: <Flame className="h-4 md:h-10 w-4 md:w-10 text-white" />,
      name: "Oil & Gas",
    ...
    {
      icon: <Heart className="h-4 md:h-10 w-4 md:w-10 text-white" />,
      name: "Healthcare",
    ...
    {
      icon: <Rocket className="h-4 md:h-10 w-4 md:w-10 text-white" />,
      name: "Aerospace",
    ...
    {
      icon: <Wheat className="h-4 md:h-10 w-4 md:w-10 text-white" />,
      name: "Agriculture",
    ...
    {
      icon: <Factory className="h-4 md:h-10 w-4 md:w-10 text-white" />,
      name: "Manufacturing",
    ...
    {
      icon: <Cpu className="h-4 md:h-10 w-4 md:w-10 text-white" />,
      name: "Energy",
    ...
    {
      icon: <Car className="h-4 md:h-10 w-4 md:w-10 text-white" />,
      name: "Automotive",
      bgColor: "bg-black/20",
    ...
    {
      icon: <Leaf className="h-4 md:h-10 w-4 md:w-10 text-white" />,
      name: "Sustainability",
  ...
  return (
    <div className="container px-2 md:px-6 py-4 md:py-16 relative" id="business-partners">
        ...
        <div className="grid gap-4 md:gap-8 md:grid-cols-2">
          <div className="space-y-3 md:space-y-6">
            ...
            <div>
              <a
                href="#contact"
                className="inline-flex items-center px-3 md:px-4 py-2 rounded-md bg-[#01F9C6] text-[#004953] hover:bg-[#01F9C6]/90 transition-colors font-medium text-sm md:text-lg"
              >
                Contact Us <ArrowRight className="ml-1 md:ml-2 h-3 w-3 md:h-4 md:w-4" />
              </a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-2 md:gap-4">
            {industries.map((industry, index) => (
              ...
              >
                <div className="mb-1 md:mb-3">{industry.icon}</div>
                <p className="text-white font-medium text-xs md:text-lg">{industry.name}</p>
              </div>
            ))}
          </div>
        </div>
