...
export default function TeamSection() {
  const team = [
    ...
    },
    {
      ...
      image:
        "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/alesagula-1gDy7EWJAz339nREa6XP184LtGKXRd.jpeg",
    },
    {
      name: "Damian Minnock",
      ...
      image:
        "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/damian.jpg-QJtCUyZNrHwbqwzufrI74Rs0MtwF4R.jpeg",
    },
    {
    ...
    },
    {
      ...
      image:
        "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/joaquin.jpg-96rpwQDiOQcEwd3svKiVRDN9SS7Eyc.jpeg",
    },
  ]
  ...
  return (
    <div className="container px-2 md:px-6">
      ...
      {/* Second row: Florencia, Joaquin (matched gap and centered) */}
      <div className="container px-2 md:px-6 mb-8 md:mb-16">
        {/* gap-3 on mobile, md:gap-6 on desktop to match the first row */}
