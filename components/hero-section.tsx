      ...
      <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center min-h-[calc(100vh-4rem)]">
        <AnimatedSection direction="left">
          <h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-light w-full">
            <span className="inline-block w-full px-2 py-0 mb-2 text-white font-bold leading-tight">Helping businesses thrive through AI</span>
          </h1>
        </AnimatedSection>
        ...
        >
          <p className="text-2xl sm:text-3xl md:text-4xl text-white">
            We turn complex challenges into measurable impact through <span className="text-[#01F9C6] font-medium">AI automation, end-to-end product engineering, applied R&D,</span> and elite embedded talent.
          </p>
        </div>
      </div>
    </div>
