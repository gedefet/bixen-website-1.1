...
const services = [
  ...
  },
  {
    ...
    description:
      "Access our network of certified AI professionals. We handle the sourcing, screening, and matching to provide you with top-tier talent ready to integrate seamlessly and drive immediate impact.",
  },
]
